...
%generelle Performance. Delf ist besser aber noch im vergleichbaren bereich. Unterscheidet sich auch sehr nach kategorie. Gibt generell schwerere Kategorien (sophienkirche semperoper) die schlecht laufen. Die sind z.b besonders von zerstörung und baulichen veränderungen betroffen.
%betrachte die schlechtesten queries
\begin{figure}[h]
\centering
...
\label{worst_queries}
\end{figure}
%bei sempi bauliche veränderungen, krasse perspektiven, zerstörung..
%bei zerstörung kann man nur schwer matchen. bsp von sophienkirche df_pos-2012-c_0000044.jpg mit pr-kruve die zerstörung zeigt
\begin{figure}[h]
\centering
