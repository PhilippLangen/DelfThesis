...
\end{figure}
Zerstörung und architektonischer Wandel sind dabei nicht die einzigen Aspekte, die den historischen Datensatz besonders anspruchsvoll für das Image Retrieval machen. Auch ein großer Anteil an Nacht- und Luftaufnahmen machen die Suche besonders schwierig. Bei in Dunkelheit aufgenommene Bildern, wie in Abbildung \ref{example_night_aerial} a zu sehen, lässt sich durch den geringen Kontrast deutlich schwerer Erkennen, welche Teile des Bildes relevante Inhalte darstellen, was die Auswahl geeigneter Deskriptoren erschwert. Auch sind viele Details kaum zu erkennen, die möglicherweise für die Erstellung von aussagekräftigen Deskriptoren genutzt werden könnten. Generell ist davon auszugehen, dass sich Deskriptoren aus Nachtbildern deutlich von Deskriptoren aus Aufnahmen bei Tageslicht unterscheiden. 
\begin{figure}[h]
\centering
