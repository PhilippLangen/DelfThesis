...
$\mathcal{S} \leftarrow \emptyset$ \;
 \While{$\mathcal{E} \neq \emptyset$}{
  ...
  $\mathcal{E} \leftarrow \mathcal{E}\, \backslash \{e_x\}$ \tcp*[f]{Verschiebe Box von Kandidaten in Auswahllist} \;
  $\mathcal{A} \leftarrow \mathcal{A}\, \backslash \{a_x\}$ \;
  $\mathcal{S} \leftarrow \mathcal{S} \cup \{(e_x,a_x)\}$ \;
  \ForEach{$e_i \in \mathcal{E}$}
  {\tcp*[f]{Entferne Boxen mit IoU > T zu currBox aus Kandidatenlist} \;
